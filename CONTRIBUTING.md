This file ensures that an efficient procedure is followed while contributing to the application. Any single person can extend this application to a way that best suits their use case.  
